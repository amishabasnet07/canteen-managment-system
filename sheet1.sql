...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 11, 2023 at 08:20 PM
...
CREATE TABLE `sheet1` (
  ...
  `itemdesc` varchar(263) DEFAULT NULL,
  `itemKeywords` varchar(247) DEFAULT NULL,
  `image` varchar(35) DEFAULT NULL,
  `salePrice` int(3) DEFAULT NULL,
...
INSERT INTO `sheet1` (`itemId`, `category_id`, `itemName`, `itemdesc`, `itemKeywords`, `image`, `salePrice`, `Quantity`) VALUES
...
(6, 3, 'Current Instant Chicken Noodles', 'Instant Chicken Noodles are a quick and savory meal made with wheat noodles and a delicious chicken flavoring. Perfect for a fast and satisfying lunch or snack.', 'Energy, protein, carbohydrates, sodium, calories,Wheat, noodles, chicken, flavoring,Savory, Salty,Comfort, Satisfaction\nInstant Chicken Noodles, Savory, Comfort Food, Salty, Quick Meal, Instant Noodles,current,currentnoodles,snacks,snack', 'Current Instant Chicken Noodles.jpg', 50, 11),
...
(19, 3, 'Hide & Seek Bourbon Biscuit', 'Parle Hide & Seek Bourbon Biscuit is a delightful chocolate cream-filled biscuit that brings delight and nostalgia with every bite.', 'snacks,snack,Energy, carbohydrates, sugar,Chocolate,cream,Sweet, Delight, Nostalgia,Biscuits', 'Hide & Seek Bourbon Biscuit.jpg', 30, 8),
...
(24, 5, 'Black Tea', 'Black tea is a classic tea variety known for its bold, brisk, and slightly bitter taste. It\'s often enjoyed with milk or sugar.', 'Black,Tea, Bitter, Astringent, Alertness, Calm,drink,hot,beverage', NULL, 15, 10),
...
(58, 4, 'Chocolate Coated Soft Biscuit', 'Chocolate Coated Soft Biscuits are delightful snacks made of soft, buttery biscuits covered in a layer of chocolate.', 'Energy, Carbohydrates, cake,Sugar, Fat, Calorie, Snack, Biscuit, Chocolate, Sweet, Happy,dessert,Excitement', 'Chocolate Coated Soft Biscuit.jpg', 50, 10),
(59, 4, 'Chocolate Chip Dough Ice Cream', 'Happy Belly Chocolate Chip Cookie Dough Ice Cream is a creamy dessert featuring chocolate chip cookie dough chunks mixed in a rich ice cream base.', 'Energy, Carbohydrates, cake,Sugar, Fat, Calories,IceCream, HappyBelly, Chocolate, Sweet, Happy,dessert,Excitement', 'Chocolate Chip Dough Ice Cream.jpg', 50, 22),
(60, 4, 'Vanilla Bean Ice Cream', 'Happy Belly Vanilla Bean Ice Cream is a classic treat with a smooth and creamy vanilla flavor.', 'Energy, Carbohydrates, Sugar, Fat, Calories,Excitement,ice Cream, Happy Belly, Vanilla, Sweet, Happy,dessert,Excitement,cake', 'Vanilla Bean IceCream.jpg', 300, 55);
COMMIT;
